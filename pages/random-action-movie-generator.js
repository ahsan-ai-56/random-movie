...
export default function ActionMoviePage() {
  ...
  return (
    <Layout breadcrumb={[{ label: "Home", href: "/" }, { label: "Action Movie Generator" }]}>
      ...
      <CinematicBackground variant="action" />
      ...
      <div className="tool-page-bg-wrap">
        ...
        <section className="feature-showcase">
          <div className="eyebrow">Built for Action Fans</div>
          <h2 className="section-heading">Filter Action Movies the Way You Actually Watch Them</h2>
          <p className="section-sub">
            Use the Advanced Filters above to combine genre with era, language, rating, runtime, and mood.
          </p>
          ...
          <div className="feature-row">
            ...
            <div className="feature-row-text">
              <span className="feature-row-tag">Runtime + Rating Together</span>
              <h3>From a tight 90-minute popcorn flick to a 3-hour epic</h3>
              <p>
                Set Runtime to <strong>Short</strong> for a quick adrenaline fix, or <strong>Long</strong>{" "}
                for a full action epic, and stack it with a <strong>7+ Very Good</strong> rating floor so
                your pick is never just loud — it's actually well-reviewed too.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row feature-row--reverse">
            ...
            <div className="feature-row-text">
              ...
              <h3>Hollywood blockbusters or international action cinema</h3>
              <p>
                Action is one of the most globally produced genres — set Language to Korean or Hindi to
                surface acclaimed international action films you might not find browsing English-only
                recommendations.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row">
            ...
            <div className="feature-row-text">
              ...
              <h3>For when you want grit, not just spectacle</h3>
              <p>
                Set Mood to <strong>Dark &amp; Intense</strong> to bias your action pick toward grittier,
                crime-and-thriller-adjacent action films rather than lighter, more comedic entries in the
                genre.
              </p>
            </div>
          </div>
