...
export default function ComedyMoviePage() {
  ...
  return (
    <Layout breadcrumb={[{ label: "Home", href: "/" }, { label: "Comedy Movie Generator" }]}>
      ...
      <CinematicBackground variant="comedy" />
      ...
      <div className="tool-page-bg-wrap">
        ...
        <section className="feature-showcase">
          <div className="eyebrow">Built for Comedy Nights</div>
          <h2 className="section-heading">Filter Comedy the Way You Actually Need a Laugh</h2>
          ...
          <div className="feature-row">
            ...
            <div className="feature-row-text">
              <span className="feature-row-tag">Mood: Funny</span>
              <h3>Skip straight to the lighter end of comedy</h3>
              <p>
                Set Mood to <strong>Funny</strong> to nudge results toward broadly comedic films, or try{" "}
                <strong>Feel Good</strong> if you want something warm and uplifting rather than laugh-out-
                loud absurd.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row feature-row--reverse">
            ...
            <div className="feature-row-text">
              ...
              <h3>90s screwball, 2000s gross-out, or new releases</h3>
              <p>
                Comedy styles shift noticeably by decade. Use the Release Year filter to land on a specific
                era's sense of humor instead of letting the algorithm mix every decade together.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row">
            ...
            <div className="feature-row-text">
              ...
              <h3>Comedy that works for every age in the room</h3>
              <p>
                Set Mood to <strong>Family Friendly</strong> to lean toward comedies that double as Family
                or Animation titles — safer territory for movie night with kids in the room.
              </p>
            </div>
          </div>
        </section>
