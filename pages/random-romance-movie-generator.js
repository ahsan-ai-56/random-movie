...
export default function RomanceMoviePage() {
  ...
  return (
    <Layout breadcrumb={[{ label: "Home", href: "/" }, { label: "Romance Movie Generator" }]}>
      ...
      <CinematicBackground variant="romance" />
      ...
      <div className="tool-page-bg-wrap">
        ...
        <section className="feature-showcase">
          <div className="eyebrow">Built for Date Night</div>
          <h2 className="section-heading">Filter Romance the Way Two People Actually Agree</h2>
          ...
          <div className="feature-row">
            ...
            <div className="feature-row-text">
              <span className="feature-row-tag">Mood: Romantic</span>
              <h3>Skip the dramas, lean into the love story</h3>
              <p>
                Set Mood to <strong>Romantic</strong> to keep the focus squarely on the relationship at the
                center of the film, or try <strong>Feel Good</strong> if you want something warmer and
                lighter than a heavier romantic drama.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row feature-row--reverse">
            ...
            <div className="feature-row-text">
              ...
              <h3>Bollywood romance, French drama, or Korean melodrama</h3>
              <p>
                Romance is told differently across cultures. Set Language to Hindi, French, or Korean to
                explore acclaimed international love stories instead of defaulting to English-language
                rom-coms every time.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row">
            ...
            <div className="feature-row-text">
              ...
              <h3>Golden-age romance or modern rom-coms</h3>
              <p>
                Set Release Year to <strong>Classic</strong> for sweeping old Hollywood romance, or{" "}
                <strong>New (2020+)</strong> for the latest streaming-era love stories.
              </p>
            </div>
          </div>
        </section>
