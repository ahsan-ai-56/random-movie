...
export default function ThrillerMoviePage() {
  ...
  return (
    <Layout breadcrumb={[{ label: "Home", href: "/" }, { label: "Thriller Movie Generator" }]}>
      ...
      <CinematicBackground variant="thriller" />
      ...
      <div className="tool-page-bg-wrap">
        ...
        <section className="feature-showcase">
          <div className="eyebrow">Built for Suspense Fans</div>
          <h2 className="section-heading">Filter Thrillers by the Tension You're Craving</h2>
          ...
          <div className="feature-row">
            ...
            <div className="feature-row-text">
              ...
              <h3>For when you want the heaviest, most gripping plots</h3>
              <p>
                Set Mood to <strong>Dark &amp; Intense</strong> to weight results toward crime and
                horror-adjacent thrillers — the ones built for genuine edge-of-your-seat tension.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row feature-row--reverse">
            ...
            <div className="feature-row-text">
              ...
              <h3>A tight, fast-paced thriller or a slow-burn mystery</h3>
              <p>
                Set Runtime to <strong>Short</strong> for a lean, efficiently plotted thriller, or{" "}
                <strong>Long</strong> for the kind of slow-burn conspiracy thriller that needs two hours to
                fully unravel.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row">
            ...
            <div className="feature-row-text">
              ...
              <h3>Make sure the twist actually pays off</h3>
              <p>
                A weak thriller is mostly let down by its ending. Set Rating to{" "}
                <strong>7+ Very Good</strong> or higher to stack the odds toward thrillers that actually
                stick the landing.
              </p>
            </div>
          </div>
