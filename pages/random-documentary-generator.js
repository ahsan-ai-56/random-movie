...
export default function DocumentaryPage() {
  ...
  return (
    <Layout breadcrumb={[{ label: "Home", href: "/" }, { label: "Documentary Generator" }]}>
      ...
      <CinematicBackground variant="documentary" />
      ...
      <div className="tool-page-bg-wrap">
        ...
        <section className="feature-showcase">
          <div className="eyebrow">Built for Curious Minds</div>
          <h2 className="section-heading">Filter Documentaries by Subject, Era, and Depth</h2>
          ...
          <div className="feature-row">
            ...
            <div className="feature-row-text">
              ...
              <h3>Skip the filler, keep the genuinely acclaimed</h3>
              <p>
                Set Rating to <strong>8+ Excellent</strong> to focus on the most critically respected
                documentaries in the pool, the ones consistently praised by real audience votes.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row feature-row--reverse">
            ...
            <div className="feature-row-text">
              ...
              <h3>A quick 80-minute deep dive or a sprawling two-hour epic</h3>
              <p>
                Set Runtime to <strong>Short</strong> for a tight, focused documentary you can finish in one
                sitting, or <strong>Long</strong> for the kind of expansive subject that needs more room.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row">
            <div className="feature-row-media">
              <img
                src="https://images.unsplash.com/photo-1465101162946-4377e57745c3?w=700&q=80"
                alt="Globe and world map representing international documentary language filtering"
                loading="lazy"
              />
            </div>
            <div className="feature-row-text">
              <span className="feature-row-tag">Language Filter</span>
              <h3>Stories told from outside the English-speaking world</h3>
              <p>
                Set Language to French, Korean, or Japanese to surface acclaimed international
                documentaries that rarely show up in English-only recommendation feeds.
              </p>
            </div>
          </div>
        </section>
