...
export default function SciFiMoviePage() {
  ...
  return (
    <Layout breadcrumb={[{ label: "Home", href: "/" }, { label: "Sci-Fi Movie Generator" }]}>
      ...
      <CinematicBackground variant="scifi" />
      ...
      <div className="tool-page-bg-wrap">
        ...
        <section className="feature-showcase">
          <div className="eyebrow">Built for Sci-Fi Fans</div>
          <h2 className="section-heading">Filter Science Fiction by the Universe You Want</h2>
          ...
          <div className="feature-row">
            <div className="feature-row-media">
              <img
                src="https://images.unsplash.com/photo-1462331940025-496dfbfc7564?w=700&q=80"
                alt="Galaxy and stars representing mind-bending sci-fi mood filtering"
                loading="lazy"
              />
            </div>
            <div className="feature-row-text">
              <span className="feature-row-tag">Mood: Mind-Bending</span>
              <h3>For time loops, simulations, and reality-bending plots</h3>
              <p>
                Set Mood to <strong>Mind-Bending</strong> to weight results toward Sci-Fi and Mystery
                hybrids — the films built around a puzzle-box plot rather than just space spectacle.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row feature-row--reverse">
            ...
            <div className="feature-row-text">
              <span className="feature-row-tag">Rating Filter</span>
              <h3>Skip the cheesy B-movies, keep the acclaimed sci-fi</h3>
              <p>
                Sci-fi has a wide quality range, from genre classics to forgettable B-movies. Set Rating to{" "}
                <strong>8+ Excellent</strong> to stay firmly in critically respected territory.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row">
            ...
            <div className="feature-row-text">
              ...
              <h3>Retro-futuristic classics or modern blockbusters</h3>
              <p>
                Set Release Year to <strong>Classic</strong> for the genre-defining sci-fi of decades past,
                or <strong>New (2020+)</strong> for the latest big-budget science fiction.
              </p>
            </div>
          </div>
        </section>
