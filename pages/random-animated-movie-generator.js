    ...
    <Layout breadcrumb={[{ label: "Home", href: "/" }, { label: "Animated Movie Generator" }]}>
      ...
      <div className="tool-page-bg-wrap">
        ...
        <section className="feature-showcase">
          <div className="eyebrow">Built for Animation Fans</div>
          <h2 className="section-heading">Filter Animation by Tone, Era, and Audience</h2>
          ...
          <div className="feature-row">
            <div className="feature-row-media">
              <img
                src="https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?w=700&q=80"
                alt="Family watching an animated movie together representing family friendly mood filtering"
                loading="lazy"
              />
            </div>
            <div className="feature-row-text">
              <span className="feature-row-tag">Mood: Family Friendly</span>
              <h3>Stay safely in family-appropriate territory</h3>
              <p>
                Set Mood to <strong>Family Friendly</strong> to weight results toward Family and Animation
                crossover titles, away from more mature adult-oriented animated films.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row feature-row--reverse">
            ...
            <div className="feature-row-text">
              <span className="feature-row-tag">Language: Japanese</span>
              <h3>Surface acclaimed anime, not just Western studios</h3>
              <p>
                Set Language to <strong>Japanese</strong> to focus the pool on anime films specifically,
                separate from Western animated features.
              </p>
            </div>
          </div>
          ...
          <div className="feature-row">
            <div className="feature-row-media">
              <img
                src="https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=700&q=80"
                alt="Colorful paint and art supplies representing decade-based animation filtering"
                loading="lazy"
              />
            </div>
            <div className="feature-row-text">
              <span className="feature-row-tag">Decade Filter</span>
              <h3>Hand-drawn classics or modern 3D animation</h3>
              <p>
                Set Release Year to <strong>Classic</strong> for traditional hand-drawn animation, or{" "}
                <strong>New (2020+)</strong> for the latest 3D and hybrid animation styles.
              </p>
            </div>
          </div>
        </section>
